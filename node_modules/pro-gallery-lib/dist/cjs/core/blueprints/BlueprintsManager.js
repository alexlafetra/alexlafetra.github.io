...
var BlueprintsManager = /** @class */ (function () {
    ...
    BlueprintsManager.prototype.completeParams = function (params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, dimensions, container, items, styles, styleParams, options, domId;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = params || {}, dimensions = _a.dimensions, container = _a.container, items = _a.items, styles = _a.styles, styleParams = _a.styleParams, options = _a.options, domId = _a.domId;
    ...
    BlueprintsManager.prototype.eventsListenerWrapper = function (eventsListenerFunc, originalArgs) {
