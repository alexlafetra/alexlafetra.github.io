...
export default {
    ...
    autoSlideshowInterval: autoSlideshowInterval,
    smartCrop: smartCrop,
    minItemSize: minItemSize,
    scrollAnimation: scrollAnimation,
    slideAnimation: slideAnimation,
    scatter: scatter,
    rotatingScatter: rotatingScatter,
    thumbnailSpacings: thumbnailSpacings,
    slideshowLoop: slideshowLoop,
    arrowsPadding: arrowsPadding,
    arrowsSize: arrowsSize,
    slideshowInfoSize: slideshowInfoSize,
    textBoxHeight: textBoxHeight,
    calculateTextBoxWidthMode: calculateTextBoxWidthMode,
    chooseBestGroup: chooseBestGroup,
    imageLoadingMode: imageLoadingMode,
    cropOnlyFill: cropOnlyFill,
    groupsPerStrip: groupsPerStrip,
    fixedColumns: fixedColumns,
    rotatingGroupTypes: rotatingGroupTypes,
    arrowsPosition: arrowsPosition,
    itemShadowSize: itemShadowSize,
    itemShadowBlur: itemShadowBlur,
    itemShadowDirection: itemShadowDirection,
    itemShadowOpacityAndColor: itemShadowOpacityAndColor,
    itemEnableShadow: itemEnableShadow,
    videoLoop: videoLoop,
    showArrows: showArrows,
    enableScroll: enableScroll,
    imagePlacementAnimation: imagePlacementAnimation,
    gallerySizeType: gallerySizeType,
    gallerySize: gallerySize,
    gallerySizePx: gallerySizePx,
    gallerySizeRatio: gallerySizeRatio,
    ...
    allowSlideshowCounter: allowSlideshowCounter,
    playButtonForAutoSlideShow: playButtonForAutoSlideShow,
    hidePlay: hidePlay,
    overlayBackground: overlayBackground,
    allowLeanGallery: allowLeanGallery,
    placeGroupsLtr: placeGroupsLtr,
