...
function getStyleByGalleryType(styles) {
    ...
    var galleryTypes = {
        ...
        one_col: function () { return ({
            ...
            groupSize: 1,
            groupTypes: '1',
            targetItemSize: function () { return dimensionsHelper.getGalleryWidth(); },
            fixedColumns: 1,
        }); },
        one_row: function () { return ({
            ...
            groupSize: 1,
            groupTypes: '1',
            targetItemSize: function () { return dimensionsHelper.getGalleryHeight(); },
            fixedColumns: 0,
        }); },
        slideshow: function () { return ({
            showArrows: true,
            cubeImages: true,
            cubeRatio: function () { return dimensionsHelper.getGalleryRatio(); },
            isVertical: true,
            targetItemSize: function () { return dimensionsHelper.getGalleryWidth(); },
            galleryType: 'Columns',
            groupSize: 1,
...
function addLayoutStyles(styles, customExternalInfoRendererExists) {
    ...
    if (!utils.isUndefined(galleryLayoutV1) &&
