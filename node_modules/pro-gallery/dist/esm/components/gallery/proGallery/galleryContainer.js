...
var GalleryContainer = /** @class */ (function (_super) {
    ...
    GalleryContainer.prototype.getVisibleItems = function (items, container) {
        ...
        if ((utils.isSSR() && !this.props.settings.renderVisibleItemsInSsr) ||
            isSEOMode() ||
            isEditMode() ||
            gotFirstScrollEvent ||
            scrollY > 0 ||
    ...
    GalleryContainer.prototype.render = function () {
        ...
        return (React.createElement("div", { "data-key": "pro-gallery-inner-container", key: "pro-gallery-inner-container", className: this.props.isPrerenderMode ? 'pro-gallery-prerender' : '' },
