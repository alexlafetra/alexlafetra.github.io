...
var SlideshowView = /** @class */ (function (_super) {
    ...
    SlideshowView.prototype.nextItem = function (_a) {
        ...
        try {
            ...
            scrollToItemPromise.then(function () {
                ...
                utils.setStateAndLog(_this, 'Next Item', {
                    currentIdx: nextItem,
                }, function () {
    ...
    SlideshowView.prototype.onCurrentItemChanged = function () {
        if (this.lastCurrentItem !== this.state.currentIdx) {
            ...
            var currentGalleryItem = this.props.galleryStructure.galleryItems[this.state.currentIdx];
            var item = this.props.items[this.state.currentIdx];
            if (item) {
    ...
    SlideshowView.prototype.createThumbnails = function (thumbnailPosition) {
        ...
        return (React.createElement("div", { className: 'pro-gallery inline-styles thumbnails-gallery ' +
            ...
            React.createElement("div", { "data-hook": "gallery-thumbnails-column", className: 'galleryColumn', key: 'thumbnails-column', style: Object.assign(thumbnailsStyle, { width: width, height: height }) }, thumbnailItems.map(function (item, idx) {
                var _a;
                ...
                return (React.createElement("div", { key: 'thumbnail-' +
                        ...
                        (highlighted
                            ...
                            : ''), "data-key": thumbnailItem.id, style: itemStyle, onClick: function () { return _this.scrollToThumbnail(thumbnailItem.idx); } }, item.type === 'text' ? (React.createElement(TextItem, __assign({}, _this.props, thumbnailItem.renderProps(), { actions: {}, imageDimensions: itemStyle, style: __assign(__assign({}, thumbnailItem.renderProps().style), itemStyle) }))) : null));
            }))));
    };
    ...
    SlideshowView.prototype.createNavArrows = function () {
        var _this = this;
        var _a = this.props.styleParams, isRTL = _a.isRTL, oneRow = _a.oneRow, arrowsColor = _a.arrowsColor, isSlideshow = _a.isSlideshow, slideshowInfoSize = _a.slideshowInfoSize, imageMargin = _a.imageMargin, arrowsSize = _a.arrowsSize, arrowsPadding = _a.arrowsPadding, arrowsPosition = _a.arrowsPosition, showArrows = _a.showArrows;
        ...
        var arrowRenderer, navArrowsContainerSize;
        if (customNavArrowsRenderer) {
            ...
            var svgStyle_1 = { transform: "scale(" + scalePercentage + ")" };
            var svgInternalStyle_1 = {};
            if (utils.isMobile()) {
                if (typeof arrowsColor !== 'undefined') {
                    svgInternalStyle_1.fill = arrowsColor.value;
                }
            }
            navArrowsContainerSize = 100;
            arrowRenderer = function (position) {
                if (position === 'left') {
                    return (React.createElement("svg", { width: "23", height: "39", viewBox: "0 0 23 39", style: svgStyle_1 },
                        React.createElement("path", { className: "slideshow-arrow", style: svgInternalStyle_1, d: "M154.994,259.522L153.477,261l-18.471-18,18.473-18,1.519,1.48L138.044,243Z", transform: "translate(-133 -225)" })));
                }
                else if (position === 'right') {
                    return (React.createElement("svg", { width: "23", height: "39", viewBox: "0 0 23 39", style: svgStyle_1 },
                        React.createElement("path", { className: "slideshow-arrow", style: svgInternalStyle_1, d: "M857.005,231.479L858.5,230l18.124,18-18.127,18-1.49-1.48L873.638,248Z", transform: "translate(-855 -230)" })));
                }
            };
        }
        var containerPadding = (navArrowsContainerSize - arrowsSize) / 2;
        ...
        var containerStyle = {
            ...
            top: "calc(50% - " + navArrowsContainerSize / 2 + "px + " + imageMargin / 4 + "px - " + slideshowSpace / 2 + "px)",
        };
        // Add negative positioning for external arrows. consists of arrow size, half of arrow container and padding
        var arrowsPos = oneRow && arrowsPosition === GALLERY_CONSTS.arrowsPosition.OUTSIDE_GALLERY
        ...
        return [
            hideLeftArrow ? null : (React.createElement("button", { className: 'nav-arrows-container prev ' +
                    (utils.isMobile() ? 'pro-gallery-mobile-indicator ' : ''), onClick: function () { return _this._next({ direction: -1 }); }, "aria-label": (isRTL ? 'Next' : 'Previous') + " Item", tabIndex: utils.getTabIndex('slideshowPrev'), key: "nav-arrow-back", "data-hook": "nav-arrow-back", style: __assign(__assign({}, containerStyle), prevContainerStyle) }, arrowRenderer('left'))),
            hideRightArrow ? null : (React.createElement("button", { className: 'nav-arrows-container next', onClick: function () { return _this._next({ direction: 1 }); }, "aria-label": (!isRTL ? 'Next' : 'Previous') + " Item", tabIndex: utils.getTabIndex('slideshowNext'), key: "nav-arrow-next", "data-hook": "nav-arrow-next", style: __assign(__assign({}, containerStyle), nextContainerStyle) }, arrowRenderer('right'))),
        ];
    };
    SlideshowView.prototype.createLayout = function () {
            ...
            return (layoutGroupView &&
                layoutGroupView.map(function (group) {
                    return group.rendered
                        ? React.createElement(GroupView, __assign(__assign({ allowLoop: _this.props.styleParams.slideshowLoop &&
        ...
        return galleryStructure.columns.map(function (column, c) {
            ...
            return (React.createElement("div", { "data-hook": "gallery-column", id: "gallery-horizontal-scroll", className: "gallery-horizontal-scroll gallery-column hide-scrollbars " + (_this.props.styleParams.isRTL ? ' rtl ' : ' ltr ') + " " + (_this.props.styleParams.scrollSnap ? ' scroll-snap ' : '') + " ", key: 'column' + c, style: columnStyle },
    ...
    SlideshowView.prototype.createGallery = function () {
        ...
        return (React.createElement("div", { id: "pro-gallery-container", className: 'pro-gallery inline-styles one-row hide-scrollbars ' +
    ...
    SlideshowView.prototype.createSlideShowNumbers = function () {
        ...
        return (React.createElement("div", { className: 'auto-slideshow-counter', "data-hook": "auto-slideshow-counter", style: __assign({ top: "calc(100% - " + slideshowInfoSize + "px + 3px)" }, side) },
            React.createElement("div", null, (this.state.currentIdx % totalItemsCount) +
                1 +
                '/' +
                totalItemsCount)));
    };
    ...
    SlideshowView.prototype.render = function () {
        ...
        return (React.createElement("div", { className: this.getClassNames(), style: this.getStyles(), onKeyDown: this.handleSlideshowKeyPress, role: "region", "aria-label": this.props.proGalleryRegionLabel },
            thumbnails[0],
            gallery,
            thumbnails[1]));
    };
