...
var BaseGallery = /** @class */ (function (_super) {
    ...
    BaseGallery.prototype.render = function () {
        ...
        var _styles = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, pro_gallery_lib_1.defaultStyles), options), styles), styleParams); //TODOVER3 can we remove the default styles?? blueprints should take care of it
