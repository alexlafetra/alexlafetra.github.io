    ...
    SlideshowView.prototype.createNavArrows = function () {
        ...
        if (customNavArrowsRenderer) {
            ...
            arrowRenderer = function (position) {
                if (position === 'left') {
                    return (react_1.default.createElement("svg", { width: "23", height: "39", viewBox: "0 0 23 39", style: svgStyle_1 },
                        react_1.default.createElement("path", { className: "slideshow-arrow", style: svgInternalStyle_1, d: "M154.994,259.522L153.477,261l-18.471-18,18.473-18,1.519,1.48L138.044,243Z", transform: "translate(-133 -225)" })));
                }
                else if (position === 'right') {
                    return (react_1.default.createElement("svg", { width: "23", height: "39", viewBox: "0 0 23 39", style: svgStyle_1 },
                        react_1.default.createElement("path", { className: "slideshow-arrow", style: svgInternalStyle_1, d: "M857.005,231.479L858.5,230l18.124,18-18.127,18-1.49-1.48L873.638,248Z", transform: "translate(-855 -230)" })));
                }
            };
        }
