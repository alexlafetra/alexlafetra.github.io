...
var ImageItem = /** @class */ (function (_super) {
    ...
    ImageItem.prototype.getImageElement = function () {
        ...
        var image = function () {
            ...
            var src = pro_gallery_lib_1.isSEOMode()
                ? createUrl(pro_gallery_lib_1.GALLERY_CONSTS.urlSizes.RESIZED, pro_gallery_lib_1.GALLERY_CONSTS.urlTypes.SEO)
                : createUrl(pro_gallery_lib_1.GALLERY_CONSTS.urlSizes.MULTI, pro_gallery_lib_1.GALLERY_CONSTS.urlTypes.HIGH_RES);
            var highres = (react_1.default.createElement(imageRenderer_1.default, tslib_1.__assign({ key: 'image_highres-' + id, className: "gallery-item-visible gallery-item gallery-item-preloaded", "data-hook": "gallery-item-image-img", "data-idx": idx, src: src, alt: alt ? alt : 'untitled image', onLoad: _this.handleHighResImageLoad, style: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, restOfDimensions), blockDownloadStyles), (!shouldRenderHighResImages && preloadStyles)) }, imageProps)));
