...
var ItemView = /** @class */ (function (_super) {
    ...
    ItemView.prototype.getImageItem = function (imageDimensions) {
        ...
        return (react_1.default.createElement(imageItem_js_1.default, tslib_1.__assign({}, props, { key: "imageItem", imageDimensions: imageDimensions, isThumbnail: !!this.props.thumbnailHighlightId, actions: {
                handleItemMouseDown: this.handleItemMouseDown,
                handleItemMouseUp: this.handleItemMouseUp,
    ...
    ItemView.prototype.getItemInner = function () {
        ...
        var width = imageDimensions.width, height = imageDimensions.height, margin = imageDimensions.margin;
        var itemStyles = { width: width, height: height };
        var marginVal = margin && Number(margin.replace('0 ', '').replace('px', ''));
        var fitInfoStyles = marginVal
            ? {
        ...
        if (styleParams.isSlideshow) {
            ...
            var infoStyle = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ height: styleParams.slideshowInfoSize + "px", bottom: "-" + styleParams.slideshowInfoSize + "px" }, fitInfoStyles), fadeAnimationStyles), { transition: 'none' });
