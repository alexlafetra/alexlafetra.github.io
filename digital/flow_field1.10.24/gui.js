...
function initGui(){
    ...
    maskParticlesCheckbox = new GuiCheckbox("Mask Off Oceans",flowField.maskParticles);
    ...
    normalizeVelocityCheckbox = new GuiCheckbox("Normalize Velocity",flowField.normalizeVelocity);

    presetSelector = new GuiDropdown(presets,activePreset);
...
function updateSliders(){
    ...
    flowField.normalizeVelocity = normalizeVelocityCheckbox.value();

    showHOLCTracts = showHOLCcheckbox.value();
    flowField.maskParticles = maskParticlesCheckbox.value();
    ...
    if(activePreset != presetSelector.selected()){
        presets[presetSelector.selected()].setActive(presetSelector.selected());
    }
}
