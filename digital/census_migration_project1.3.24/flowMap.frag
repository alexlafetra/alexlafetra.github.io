...
void main(){
    ...
    vec2 c = vec2(0.0);
    c+=(uPoint1.xy-vTexCoord)/(d1*d1*d1);
    c+=(uPoint2.xy-vTexCoord)/(d2*d2*d2);
    c+=(uPoint3.xy-vTexCoord)/(d3*d3*d3);
    c+=(uPoint4.xy-vTexCoord)/(d4*d4*d4);
    c+=(uPoint5.xy-vTexCoord)/(d5*d5*d5);
