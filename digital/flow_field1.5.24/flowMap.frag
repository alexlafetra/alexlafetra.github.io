...
void main(){
    ...
    // c+=(uPoint4.xy-vTexCoord)/(d4*d4);
    // c+=(uPoint5.xy-vTexCoord)/(d5*d5);
    // c+=(uPoint6.xy-vTexCoord)/(d6*d6);
    // c+=(uPoint7.xy-vTexCoord)/(d7*d7);
    // c+=(uPoint8.xy-vTexCoord)/(d8*d8);
    // c+=(uPoint9.xy-vTexCoord)/(d9*d9);
    // c+=(uPoint10.xy-vTexCoord)/(d10*d10);
