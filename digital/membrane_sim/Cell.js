...
class Cell{
  constructor(x,y,r,clr){
    this.c = clr;
    //let nodeNumber = 2*PI*r/minDistance;
    let nodeNumber = r/5;
    this.nodes = [];
...
//hmmm...self avoiding also makes sense though
//you would want to passively avoid vertices on the other side of your body
//maybe this can also happen thru dynamic pressure? but for now I'm leaving
//self-avoidance in (it's cooler)
      //if(this != cellList[i]){
