...
class Cell{
  ...
  show(){
    ...
    for(let i = 0; i<this.nodes.length; i++){
      ...
      let len = 200+p5.Vector.dist(this.nodes[this.nodes[i].nearest].position,this.nodes[i].position);
      stroke(len%400,200,400);
      line(this.nodes[this.nodes[i].nearest].position.x,this.nodes[this.nodes[i].nearest].position.y,this.nodes[i].position.x,this.nodes[i].position.y);
      len = 200+p5.Vector.dist(this.nodes[this.nodes[i].secondNearest].position,this.nodes[i].position);
      stroke(len%400,400,400);
      line(this.nodes[this.nodes[i].secondNearest].position.x,this.nodes[this.nodes[i].secondNearest].position.y,this.nodes[i].position.x,this.nodes[i].position.y);
    }
  }
}
