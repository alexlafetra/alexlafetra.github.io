...
function initGui(){
    let gui = createDiv();
    gui.id("gui");
    noiseOpacitySlider = new GuiSlider(0.00,1.0,noiseOpacity,0.01,"Noise Opacity",'noiseOpacity');
    noiseScaleSlider = new GuiSlider(0.00,1.0,noiseScale,0.01,"Noise Scale",'noiseScale');
}

function updateSliders(){
    noiseOpacity = noiseOpacitySlider.value();
