...
class Wiggle{
  ...
  render(){
    ...
    curveVertex(this.points[numberOfPoints-1].x+20,this.points[numberOfPoints-1].y);
...
function applyGrain() {
  ...
  grainShader.setUniform('noiseSeed', 2); // to make the grain change each frame
