//this SHOULD stay the same as the intro boids on index.html!
//update this one if you change the other one
//the only diff is that this one doesn't move the center menu
const flock = []; 
